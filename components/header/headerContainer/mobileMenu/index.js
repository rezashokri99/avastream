...
const MobileMenu = ({ isOpenMobileMenu, isOpenPages, setIsOpenPages }) => {
    ...
    return (
        <ul className={`${isOpenMobileMenu ? isOpenPages ? "h-[325px]" : "h-[135px]" : "h-0"} lg:hidden rounded-sm transition-[height] ease-in duration-500 overflow-hidden rtl mx-[15px] bg-fuchsia-100`}>
