    ...
    return (
        <ul className="hidden lg:flex rtl items-center text-white">
            ...
            <li className="px-5 border-r border-gray-500">
                <Link href="#">
                    <a className="hover:text-red-orginal transition ease-in-out delay-150 cursor-pointer font-bold ">خانه</a>
                </Link>
            </li>
            <li className="px-5 border-r border-gray-500">
                <Link href="#">
                    <a className="hover:text-red-orginal transition ease-in-out delay-150 cursor-pointer font-bold ">فیلم ها</a>
                </Link>
            </li>
            <li onClick={openAndClosePagesInDesktop} className="px-5 border-r border-gray-500 flex items-center">
                <p className="hover:text-red-orginal transition ease-in-out delay-150 cursor-pointer font-bold">صفحه ها</p>
