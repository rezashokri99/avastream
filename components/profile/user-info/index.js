...
const UserInfo = () => {
    ...
    return (
        <div className="rtl text-right text-white">
            <div>
                <h5 className="my-4 pb-4 text-xl font-bold border-b text-white">اطلاعات کلی</h5>
            ...
            <form>
                <h5 className="my-4 pb-4 text-xl font-bold border-b text-white">تغییر رمز عبور</h5>
                <div className="pb-4 lg:grid lg:grid-cols-2 justify-center gap-x-8">
                    {/* پسورد فعلی */}
